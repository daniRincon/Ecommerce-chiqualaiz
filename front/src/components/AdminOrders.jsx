...
export default function AdminOrders({ adminOrders, books, authorized }) {
  ...
  const handleSelectAllClick = event => {
    if (event.target.checked) {
      const newSelecteds = admin.map(n => n.name);
        ...
        <Paper className={classes.paper}>
          ...
          <div className={classes.tableWrapper}>
            ...
            >
              ...
              />
              <TableBody>
                {stableSort(adminOrders, getSorting(order, orderBy))
                  .slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                  .map((adminOrder, index) => {
                    const isItemSelected = isSelected(adminOrder.name);
                    const labelId = `enhanced-table-checkbox-${index}`;

                    return (
                      <TableRow
                        hover
                        onClick={event => handleClick(event, adminOrder.name)}
                        role="checkbox"
                      ...
                      >
                        <TableCell align="right">{adminOrder.name}</TableCell>
